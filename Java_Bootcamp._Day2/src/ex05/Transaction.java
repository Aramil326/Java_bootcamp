...
public class Transaction {
    ...
    public Transaction(User recipient, User sender, Category transferCategory, Integer transferAmount) {
        ...
        } else if ((transferCategory == Category.DEBIT && transferAmount > sender.getBalance()) || (transferCategory == Category.CREDIT && -transferAmount > sender.getBalance())) {
    ...
    public String toString() {
        return "id:\t" + id + "recipient:\t" + recipient.getName() + "\t=>\tsender:\t" + sender.getName() + ";\ttransferCategory:\t" +
