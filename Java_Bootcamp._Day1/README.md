...
2. [Exercise 00 – Сумма цифр]()
3. [Exercise 01 – Действительно простое число]()
...
## Exercise 00 – Сумма цифр ([директория проекта](src/ex00)) 
...
## Exercise 01 – Действительно простое число ([директория проекта](src/ex01))
...
## Exercise 02 – Бесконечная последовательность (или нет?) ([директория проекта](src/ex02))
...
## Exercise 03 – Немного статистики ([директория проекта](src/ex03))
...
## Exercise 04 – Еще немного статистики ([директория проекта](src/ex04))
...
## Exercise 05 – Расписание ([директория проекта](src/ex05))
